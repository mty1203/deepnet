...
class HealpyGCNN(Sequential):
    ...
    def __init__(self, nside, indices, layers, n_neighbors=8):
        ...
        for layer in self.layers_in:
            if isinstance(layer, (hp_nn.HealpyChebyshev, hp_nn.HealpyMonomial, hp_nn.Healpy_ResidualLayer, hp_nn.HealpyBernstein,hp_nn.HealpyResBern,hp_nn.HealpyGCNNII)):
